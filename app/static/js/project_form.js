document.addEventListener('DOMContentLoaded', function() {
                ...
                <div class="story-form">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="userStoryTeam[]" required>
                            ...
                            <option value="IT Team 1">Team 1</option>
                            <option value="IT Team 2">Team 2</option>
                            <option value="IT Team 3">Team 3</option>
                            <option value="IT Team 4">Team 4</option>
                        </select>
                    </div>
                    <div class="form-group">
    ...
    function generateTeamMemberOptions() {
        const teamMembers = Array.from(document.querySelectorAll('[name="devTeam"]'))
    ...
    function submitProject(e) {
        ...
        const projectId = 'PRJ-' + (parseInt(localStorage.getItem('lastProjectId') || '0') + 1).toString().padStart(3, '0');
        localStorage.setItem('lastProjectId', projectId.split('-')[1]);
        const formData = {
            projectId: projectId,
        ...
        sprintStoriesContainer.innerHTML = selectedStories.map(story => `
            <div class="assigned-story badge badge-info mr-2 mb-2" data-story-id="${story.id}">
                ...
                <button type="button" class="close ml-2"
                        onclick="removeAssignedStory(this, ${sprintNumber})">&times;</button>
            </div>
        `).join('');
